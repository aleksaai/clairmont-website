...
import { ArrowRight, BarChart3, Shield, Globe, TrendingUp, FileCheck } from "lucide-react";
...
const Steuerberatung = () => {
  ...
  const services = [
    { icon: BarChart3, title: "Steuerliche Analyse", desc: "Analyse der aktuellen Steuersituation und Identifikation von Optimierungspotentialen." },
    { icon: TrendingUp, title: "Individuelle Strategien", desc: "Individuelle Steuerstrategien zur legalen Reduzierung der Steuerlast." },
    { icon: Globe, title: "Internationale Strukturen", desc: "Beratung zu internationalen Unternehmensstrukturen und Standortvorteilen." },
    { icon: Shield, title: "Betriebsprüfungen", desc: "Begleitung bei Betriebsprüfungen und steuerlichen Sonderfragen." },
    { icon: FileCheck, title: "Laufende Betreuung", desc: "Laufende Betreuung und Anpassung an aktuelle Gesetzesänderungen." },
  ];
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-lg md:text-xl text-[hsl(var(--glass-text))]/80 font-light max-w-2xl mx-auto mb-10">
              Maßgeschneiderte Steuerstrategien zur Minimierung der Unternehmensteuerlast — für Unternehmen ab 500.000 € Jahresumsatz.
            </p>
            <Button size="lg" className="rounded-full px-10 h-14 text-lg" onClick={() => navigate("/kontakt?service=steuerberatung")}>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-light">Clairmont Advisory vermittelt erstklassige Steuerberatung über unser exklusives Partnernetzwerk.</p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="bg-primary/5 rounded-3xl p-10 border border-primary/10">
            ...
            <p className="text-muted-foreground font-light leading-relaxed">
              Selbständige, Unternehmer und Geschäftsführer mit einem Jahresumsatz ab 500.000 €, die ihre Steuerlast nachhaltig optimieren möchten.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-primary/[0.03]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-4xl font-light text-primary mb-6">Bereit für optimierte Steuerstrategien?</h2>
