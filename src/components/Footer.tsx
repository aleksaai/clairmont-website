    ...
    <footer className="relative py-16 px-6 mt-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            <h3 className="text-primary font-medium mb-4">{t('footer', 'links')}</h3>
          ...
          <div>
            <h3 className="text-primary font-medium mb-4">{t('footer', 'legal')}</h3>
            <ul className="space-y-3">
              <li>
        ...
        <div className="pt-8 border-t border-primary/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-primary/50 text-sm font-light">
              © {new Date().getFullYear()} Clairmont Advisory. {t('footer', 'copyright')}
            </p>
            <p className="text-primary/50 text-sm font-light">
              {t('footer', 'madeWith')}
            </p>
